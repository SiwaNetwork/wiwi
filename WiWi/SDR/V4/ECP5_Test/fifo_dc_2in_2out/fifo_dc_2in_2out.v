...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n fifo_dc_2in_2out -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 16 -width 2 -rwidth 2 -reset_rel SYNC -pe -1 -pf -1 -fdc C:/Users/julianstj/Desktop/WorkNotes/Projects/PTP/WiWi/SDR/Software/ECP5_Test/fifo_dc_2in_2out/fifo_dc_2in_2out.fdc  */
/* Fri Dec 06 11:19:10 2024 */


`timescale 1 ns / 1 ps
module fifo_dc_2in_2out (Data, WrClock, RdClock, WrEn, RdEn, Reset, 
    ...
    DP16KD pdp_ram_0_0_0 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .ADB6(scuba_vlo), .ADB5(scuba_vlo), .ADB4(rptr_3), .ADB3(rptr_2), 
        .ADB2(rptr_1), .ADB1(rptr_0), .ADB0(scuba_vlo), .CEB(rden_i), .OCEB(rden_i), 
        ...
        .DOB1(Q[1]), .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="fifo_dc_2in_2out.lpc" */
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_0 MEM_LPC_FILE fifo_dc_2in_2out.lpc
