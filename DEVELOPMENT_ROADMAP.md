...
### ФИНАЛЬНОЕ ТЕСТИРОВАНИЕ: Параллельно с месяцем 7
**Период**: 15-31 мая 2026 года
...
| 1-31 декабря 2025 | 2 | Прототипы собраны | 5 рабочих образцов |
| 1-31 января 2026 | 3 | Аппаратура отлажена | Все модули работают стабильно |
| 1-28 февраля 2026 | 4 | Базовое ПО готово | Все компоненты управляются |
| 1-31 марта 2026 | 5 | WiWi адаптирован под PTP | Базовая совместимость с G.8275.1 |
| 1-30 апреля 2026 | 6 | LoRa заменен на Wi-Fi 6E | Протокол WiWi работает через Wi-Fi |
| 1-31 мая 2026 | 7 | Проект завершен | Соответствие всем требованиям ТЗ |
| 15-31 мая 2026 | Финальное тестирование | Полевые испытания | Подтверждение ±300 нс точности |
