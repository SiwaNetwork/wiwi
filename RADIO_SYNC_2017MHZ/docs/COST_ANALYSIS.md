...
### 4.1 Амортизация ОКР
- **Стоимость ОКР**: 60,160,000 руб
- **Планируемый объем продаж**: 50 изделий
- **Амортизация на изделие**: 1,203,200 руб

### 4.2 Себестоимость изделия
- **Производственная себестоимость**: 280,000 руб
- **Амортизация ОКР**: 1,203,200 руб
- **Общая себестоимость**: 1,483,200 руб

### 4.3 Ценообразование
- **Себестоимость**: 1,483,200 руб
- **Маржа (15%)**: 222,480 руб
- **Цена для заказчика**: 1,705,680 руб

### 4.4 Экономика для заказчика
- **Стоимость ОКР**: 0 руб (финансирует разработчик)
- **Стоимость изделия**: 1,705,680 руб
- **Общие затраты заказчика**: 1,705,680 руб
...
| **ОКР за свой счет** | 1,705,680 | +1,341,680 | +368.6% |
...
- **Маржа с изделия**: 222,480 руб
- **Точка безубыточности**: 270 изделий
...
#### Модель 2: ОКР за свой счет
- **Рентабельность**: 15% (после окупаемости ОКР)
- **Риски**: Очень высокие (необходимо продать 270+ изделий)
...
#### Недостатки:
- **Очень высокая цена изделия**: 1,705,680 руб (+368.6%)
- **Очень высокие риски** для разработчика
- **Необходимость продать 270+ изделий** для окупаемости
- **Длительный период окупаемости**

#### Условия применения:
- **Очень большой рынок** (270+ потенциальных заказчиков)
...
- **Цена изделия**: 1,705,680 руб
- **Минимальный объем**: 270 изделий для окупаемости
- **Общие затраты заказчика**: 1,705,680 руб × количество
