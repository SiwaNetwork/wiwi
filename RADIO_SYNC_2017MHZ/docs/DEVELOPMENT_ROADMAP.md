...
|------|--------|-----------------|-----------|
| **Этап 1: Разработка РКД** | Январь-Март 2026 | Анализ требований, системная архитектура, выбор компонентов, проектирование интерфейса коммутации, заказ компонентов | Утвержденная РКД, спецификации компонентов, готовность к производству |
| **Этап 2: Изготовление и разработка ПО и отладка** | Апрель-Август 2026 | Сборка прототипов, отладка аппаратуры, реализация PTP G.8275.1, достижение точности ±300 нс, системная интеграция, управление и мониторинг | Полностью интегрированная система с требуемой точностью |
| **Этап 3: Тестирование и доработки по результатам испытаний** | Сентябрь-Декабрь 2026 | Финальное тестирование, полевые испытания, валидация требований ТЗ, оптимизация, документация и передача | Готовый к эксплуатации продукт, переданный заказчику |
